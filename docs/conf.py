...
project = u'Waldur cost planning'
...
from waldur_cost_planning import __version__
...
htmlhelp_basename = 'waldur-cost-planningdoc'
...
latex_documents = [
  ('index', 'waldur-cost-planning.tex', u'Waldur cost planning Documentation',
   u'OpenNode', 'manual'),
]
